...
import AdminLeadskanban from "../crm/leads/AdminLeadskanban";
import UserDashboard from "../crm/dashboard/UserDashboard";
import LinkusClient from "../crm/linkus/LinkusClient";
import ScriptGenerator from "../crm/scriptGenerator/ScriptGenerator";
import ContactFaq from "../crm/leads/ContactFaq";
import AllCalls from "../crm/speakToLead/AllCalls";
import Api from "../crm/settings/Api";
import HelpAndSupport from "../crm/HelpAndSupport";
import SyncAndIntegration from "../crm/settings/SyncAndIntegration";
import ImportAndExport from "../crm/settings/ImportAndExport";
import UpgradePlan from "../crm/plans/UpgradePlan";
import ChangePassword from "../crm/settings/Security";
import Security from "../crm/settings/Security";
...
export const publicRoutes = [
  ...
  {
    path: route.linkusClient,
    name: "Linkus Client",
    element: <LinkusClient />,
    route: Route,
    title: "Linkus Client",
  },
  {
...
export const adminRoutes = [
  // Admin routes will be defined here when needed
  // Example:
  // {
