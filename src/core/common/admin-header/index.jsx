    ...
    <>
      ...
      <div className="header">
        ...
        <div className="header-left active">
          ...
          <Link to={route.adminDashboard} className="logo logo-normal">
            {/* {layoutBs === "dark" ? (
              <>
                <ImageWithBasePath
          ...
          <Link to={route.adminDashboard} className="logo-small">
            ...
            <li className="nav-item nav-list">
              <ul className="nav">
                ...
                <li className="nav-item">
                  ...
                  <div
                    className={`dropdown-menu dropdown-menu-end menus-info ${
                      openDropdown ? "show" : ""
                    }`}
                    style={{
                      minWidth: "255px",
